...
def _build_sam(
    ...
    if checkpoint is not None:
        print("Loading checkingpoint: ", checkpoint)
...
def load_from(sam, state_dict, image_size, vit_patch_size):
    ...
    print("load_from:: imgsize//patch_size: ", image_size, " " , vit_patch_size)
    ...
    print("Reshaped model manually loaded with original checkpoint's weights/biases...")
    return sam_dict
